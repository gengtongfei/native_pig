...
<div id="box">
    ...
    <div id="body">
        <div id="Login">
            <h1 align="left"><span class="h1"><img src="<%=request.getContextPath()%>/images/buttonPassword.gif"
                                                   alt="找回密码"/></span></h1>
            ...
            <div class="FPaContent">
                ...
                <p class="textSty">如果有任何疑问，请访问口口香 <span class="color3"><a href="<%=request.getContextPath()%>/#"
                                                                          target="_blank">帮助中心</a></span>，或与口口香客服部取得联系。<br/>
