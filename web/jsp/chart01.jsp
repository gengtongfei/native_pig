                    ...
                    <div class="changeAdd" align="center">
                        <ul class="ulSty">
                            <li>收 货 人：刘德华<br/>
                                ...
                                固定电话：<br/>
                                移动电话：138********<br/>
                                <span class="addDeleteSty addFontCol"><a href="<%=request.getContextPath()%>/#"><span
                                        class="addFontCol">修改</span></a><span
                                        class="addFontCol">　|</span>　<a href="<%=request.getContextPath()%>/#"><span
                                        class="addFontCol">删除</span></a></span><span
                                        class="addSpanSty"><a href="chart02.jsp"><img
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <ul class="psAdd" align="left">
                                            ...
                                            <li class="conLi7"><span class="addSpanSty"><a href="chart02.jsp"><img
