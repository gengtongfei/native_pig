        ...
        <div id="Login">
            ...
            <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="lineJL">
                ...
                <tr>
                    ...
                    <td class="sty04" valign="top" width="425" align="left"> 请填写有效的 Email地址作为下次登录的用户名，<br>
                ...
                <tr>
                    ...
                    <td class="sty01" valign="top"><input id="PassWord" name="PassWord" maxlength="16"
                                                          onchange="ChangePassword();" value="" type="password"><span
                            id="CheckRePassWord" class="Reginput"></span></td>
                ...
                <tr>
                    ...
                    <td class="sty01" valign="top"><input id="RexPassWord" name="RexPassWord" maxlength="16"
                                                          onchange="Check_RePassWord()" value="" type="password"><span
                            id="ReCheckRePassWord" class="Reginput"></span></td>
                    <td align="left">　</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="sty02" colspan="2" valign="top"><input name="Validate_Code" id="Validate_Code"
                                                                      ...
                                                                      style="width:100px;" type="text"><img id="Img1"
                                                                                                            style="vertical-align: top; padding: 0pt 0pt 0pt 8px;"
                                                                                                            src="<%=request.getContextPath()%>/images/NewValidateCode.jpg"
                                                                                                            onclick="this.src='<%=request.getContextPath()%>/PublicControls/NewValidateCode.aspx?height=25&amp;width=100&amp;codeLen=5&amp;photoType=2&amp;t='+new Date().getTime()"
                                                                                                            border="0">
                        <span class="sty03 sty04"><a href="<%=request.getContextPath()%>/javascript:ChangeImg1()">看不清，换一张</a></span>
