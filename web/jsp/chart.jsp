...
<div class="guide01">
    ...
    <map name="Map" id="Map">
        <area shape="rect" coords="398,11,493,51" href=href="<%=request.getContextPath()%>/#"/>
        ...
        <DIV id="gwc">
            ...
            <DIV class="bxSty"><!--Product-->
                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabSty01"
                    ...
                    <tr>
                        <td width="160" height="160" align="center" valign="middle"><span class="imgw"><a
                                href="<%=request.getContextPath()%>/#"
                                target="_blank"><img
                                src="<%=request.getContextPath()%>/images/pro_04.jpg" alt="带帽水洗收腰休闲夹克 灰色" border="0"
                                width="160"/></a></span></td>
                        <td><a href="<%=request.getContextPath()%>/#" target="_blank"><span class="STYLE5">推荐 新疆和田 玉枣 32元 肉厚 相当于昆仑山四星</span></a>
                        </td>
                        <td align="center">￥<span id="00072650">199.00</span></td>
                        <td align="center">
                            <input name="OrderAmount_2" id="OrderAmount_2" maxlength="3"
                        ...
                        <td align="center"><a
                                href="<%=request.getContextPath()%>/javascript:DeleteProduct('00072650',1);">删除</a></td>
                    </tr>
                    <tr>
                        <td height="160" align="center" class="gwcSuit"><span class="imgw"><a
                                href="<%=request.getContextPath()%>/#"
                                target="_blank"><img
                                src="<%=request.getContextPath()%>/images/pro_02.jpg" alt="带帽水洗收腰休闲夹克 灰色" border="0"
                                width="160"/></a></span></td>
                        <td class="gwcSuit" align="left" height="70"><a href="<%=request.getContextPath()%>/#"
                                                                        target="_blank"><span
                        ...
                        <td class="gwcSuit" align="center"><a
                                href="<%=request.getContextPath()%>/javascript:DeleteProduct('00072650',1);">删除</a>
                        </td>
                    </tr>
                    <tr>
                        <td height="160" align="center" valign="middle"><span class="imgw"><a
                                href="<%=request.getContextPath()%>/#"
                                target="_blank"><img
                                src="<%=request.getContextPath()%>/images/pro_03.jpg" alt="带帽水洗收腰休闲夹克 灰色" border="0"
                                width="160"/></a></span></td>
                        <td><a href="<%=request.getContextPath()%>/#" target="_blank"><span class="STYLE5">推荐 新疆和田 玉枣 32元 肉厚 相当于昆仑山四星</span></a>
                        </td>
                        <td align="center">￥<span id="00072650">199.00</span></td>
