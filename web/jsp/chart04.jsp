        ...
        <div id="Login">
            <DIV id="gwc">
                <div id="step_" align="left">结算步骤: <span class="" id="shoppingstep_0">1.登录注册</span> &gt;&gt; <span
                        class="" id="shoppingstep_2">2.填写核对订单信息</span> &gt;&gt; <span class="shoppingstepcontrol"
                ...
                <table class="tabSty01" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr class="trSty01" bgcolor="#7a7f89">
                        <td class="reusableColor5 xxSty01 typeBottom" align="left" valign="middle">&nbsp;&nbsp;&nbsp;&nbsp;<strong>订单已提交</strong>
                            <span id="Lb1newChange"></span></td>
                    </tr>
                    <tr>
                        <td height="100" align="center"><h3><span
                                style="color:#f90;">您好，您的订单已提交，我们会在第二个工作日进行审核请耐心等待！</span></h3></td>
                    </tr>
                    <tr>
                        <td height="50" class="typeTd2"><a href="<%=request.getContextPath()%>/#"><img
                                src="<%=request.getContextPath()%>/images/button_close.gif" border="0"
                                onclick="#"/></a><br/>
                        </td>
                </table>
<SPAN
