...
<!--guide01 end -->
<!--guide02 start-->
<div class="guide02"><a href="<%=request.getContextPath()%>/#"><img
        src="<%=request.getContextPath()%>/images/guide_02.jpg" width="492" height="107" border="0"/></a><a
        href="<%=request.getContextPath()%>/#"><img src="<%=request.getContextPath()%>/images/guide_03.jpg" width="481"
...
<div id="body">
    ...
    <div id="leftMain">
        ...
        <div id="left">
            <h2>商品分类</h2>
            <ul>
                <li><a href="inner-page.jsp">特级椒盐味</a></li>
                <li><a href="<%=request.getContextPath()%>/#">纸皮巴旦木龙果</a></li>
                <li><a href="<%=request.getContextPath()%>/#">壳杏仁 23元/500克 </a></li>
                <li><a href="<%=request.getContextPath()%>/#">纸皮巴旦木龙果</a></li>
                <li><a href="<%=request.getContextPath()%>/#">壳杏仁 23元/500克 </a></li>
                <li><a href="<%=request.getContextPath()%>/#">纸皮巴旦木龙果</a></li>
                <li><a href="<%=request.getContextPath()%>/#">壳杏仁 23元/500克</a></li>
            ...
            <ul class="leftLink">
                <li><a href="<%=request.getContextPath()%>/#">特级椒盐味</a></li>
                <li><a href="<%=request.getContextPath()%>/#">纸皮巴旦木龙果</a></li>
                <li><a href="<%=request.getContextPath()%>/#">纸皮巴旦木龙果</a></li>
                <li><a href="<%=request.getContextPath()%>/#">特级椒盐味</a></li>
                <li><a href="<%=request.getContextPath()%>/#">纸皮巴旦木龙果</a></li>
...
ssssssssss<br/>
    ...
    <div id="mid">
        ...
        <div class="hotsale">
            <dl>
                <dt><a href="inner-page.jsp" target="_new"><img src="<%=request.getContextPath()%>/images/T1.jpg"
                                                                width="310" height="310"
                                                                border="0"/></a></dt>
                <dd>实心眼 特级薄皮奶香味 巴旦木 250g</dd>
                <dd><span class="viv1">￥:18.0</span><span class="viv2"><a href="inner-page.jsp" target="_new"><img
                        src="<%=request.getContextPath()%>/images/vivioow_b2.jpg" width="80" height="24"
                        border="0"/></a></span></dd>
            </dl>
            <dl>
                <dt><a href="inner-page.jsp" target="_new"><img src="<%=request.getContextPath()%>/images/pro_02.jpg"
            ...
            <dl>
                <dt><a href="inner-page.jsp" target="_new"><img src="<%=request.getContextPath()%>/images/pro_03.jpg"
                                                                width="160" height="160"
                                                                border="0"/></a></dt>
                <dd>推荐 新疆和田 玉枣 32元 肉厚 相当于昆仑山四星</dd>
                <dd><span class="viv1">￥:18.0</span><span class="viv2"><a href="inner-page.jsp" target="_new"><img
            ...
            <dl>
                <dt><a href="inner-page.jsp" target="_new"><img src="<%=request.getContextPath()%>/images/pro_04.jpg"
                                                                width="160" height="160"
                                                                border="0"/></a></dt>
                <dd>推荐 新疆和田 玉枣 32元 肉厚 相当于昆仑山四星</dd>
                <dd><span class="viv1">￥:18.0</span><span class="viv2"><a href="inner-page.jsp" target="_new"><img
            ...
            <dl>
                <dt><a href="inner-page.jsp" target="_new"><img src="<%=request.getContextPath()%>/images/pro_05.jpg"
                                                                width="160" height="160"
                                                                border="0"/></a></dt>
                <dd>推荐 新疆和田 玉枣 32元 肉厚 相当于昆仑山四星</dd>
                <dd><span class="viv1">￥:18.0</span><span class="viv2"><a href="inner-page.jsp" target="_new"><img
            ...
            <dl>
                <dt><a href="inner-page.jsp" target="_new"><img src="<%=request.getContextPath()%>/images/pro_06.jpg"
                                                                width="160" height="160"
                                                                border="0"/></a></dt>
                <dd>推荐 新疆和田 玉枣 32元 肉厚 相当于昆仑山四星</dd>
                <dd><span class="viv1">￥:18.0</span><span class="viv2"><a href="inner-page.jsp" target="_new"><img
            ...
            <dl>
                <dt><a href="inner-page.jsp" target="_new"><img src="<%=request.getContextPath()%>/images/pro_07.jpg"
                                                                width="160" height="160"
                                                                border="0"/></a></dt>
                <dd>推荐 新疆和田 玉枣 32元 肉厚 相当于昆仑山四星</dd>
                <dd><span class="viv1">￥:18.0</span><span class="viv2"><a href="inner-page.jsp" target="_new"><img
            ...
            <dl>
                <dt><a href="inner-page.jsp" target="_new"><img src="<%=request.getContextPath()%>/images/pro_08.jpg"
                                                                width="160" height="160"
                                                                border="0"/></a></dt>
                <dd>推荐 新疆和田 玉枣 32元 肉厚 相当于昆仑山四星</dd>
                <dd><span class="viv1">￥:18.0</span><span class="viv2"><a href="inner-page.jsp" target="_new"><img
...
<div id="footer">
    ...
    <p class="design"><a href="<%=request.getContextPath()%>/http://www.CSSK8.com/" target="_blank"
                         class="link">启奥科技</a></p>
</div>
<!--footer end -->
<!--body end -->
